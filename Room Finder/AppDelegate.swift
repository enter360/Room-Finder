...
//  Room Finder
//
//  Created by Corbin Black on 3/10/17.
//  Copyright © 2017 Corbin Black. All rights reserved.
//
...
class AppDelegate: UIResponder, UIApplicationDelegate, RPKManagerDelegate{
  ...
  //      "kit_url": "https://proximitykit.radiusnetworks.com/api/kits/8991",
    //    "api_token": "f91553a1b9138cbd32cc5a7d26ec1bd267345f557ff1d7a565f4e73d1f1cf60d",
      //  ]);
    
    
   // let rpkManager = RPKManager.managerWithDelegate
    ...
    func proximityKit(manager: RPKManager!, didDetermineState state: RPKRegionState, for region: RPKRegion!) {
    ...
    lazy var persistentContainer: NSPersistentContainer = {
        ...
        */
        let container = NSPersistentContainer(name: "Room_Finder")
